...
export default function AddTeam() {
    ...
    const imageLabel = useRef<HTMLLabelElement>();
    ...
    return (
        <div className={s.container}>
            <div className={s.header}><p><Link to='/teams'>Teams</Link> / <Link to='/teams/AddTeam'>Add new team</Link></p></div>
            <form className={s.form} onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className={s.inputs}>
                    ...
                    <span>
                        ...
                        <input type="text" {...register('division')} id="Division" required/>
                    </span>
                    <span>
                        <label htmlFor="Conference">Conference</label>
                        <input type="text" {...register('conference')} id="Conference" required/>
                    </span>
                    <span>
                        <label htmlFor="Year">Year of foundation</label>
                        <input type="date" {...register('year')} id="Year" required/>
                    </span>
