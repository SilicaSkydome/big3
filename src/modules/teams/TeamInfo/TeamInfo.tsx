    ...
    <>
        <div className={s.container}>
            <div className={s.header}>
                <span>
                    <p><Link to='/teams'>Teams</Link> / <Link to='/teams/'>Add new team</Link></p>
                </span>
                <span className={s.images}>
                    <svg className={s.img} width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg className={s.img} onClick={deleteTeamHandler} width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className={s.container}>
            <div className={`${s.header} ${s.playersHeader}`}><span><p>Roster</p></span></div>
        </div>
